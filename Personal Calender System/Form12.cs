...
namespace Personal_Calender_System
{
    public partial class Form12 : Form
    {
        ...
        {
            this.Hide();
            var f13 = new Form13(event_id);
            f13.FormClosed += (s, args) => this.Close();
            f13.Show();
        }

        private void eventdisplay_TextChanged(object sender, EventArgs e)
        {
